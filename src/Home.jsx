 ...
 return (
  <div className="bg-white dark:bg-black ">
   <div className="text-center">
    <button className="btn px-2 " onClick={click}>
     mode
    </button>
   </div>
   <div className="hero">
   ...
   <div className="mt-2 md:mt-10">
    {/* extra section -1 */}
    <h1 className="text-2xl text-center mb-4 font-semibold dark:text-white">Live free with </h1>
   ...
   <div className="mt-2 md:mt-10">
    {/* extra section -2 */}
    <h1 className="text-2xl text-center mb-4 font-semibold dark:text-white">Gallery </h1>
